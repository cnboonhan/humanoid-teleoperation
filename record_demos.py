# python3 record_demos.py --device cpu --task Isaac-PickPlace-GR1T2-Abs-v0 --teleop_device dualhandtracking_abs --dataset_file ./datasets/dataset_gr1.hdf5 --num_demos 10 --enable_pinocchio
# 
